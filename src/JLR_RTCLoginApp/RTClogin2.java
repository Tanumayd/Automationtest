...
import JLR_RTCLoginCode.RTClogin;
...
public class RTClogin2 {
	...
	@BeforeMethod
	public void launchCode() throws InterruptedException
	{
	...
	@Test
	public static void LoginintoApp() throws Exception
	{
	
		
		RTClogin rp = new RTClogin(driver);
		excelCode excel=new excelCode("D:\\Selenium_class\\Automation_Test\\Data\\Datasheet.xlsx");
		rp.login(excel.readData(1,0));
		rp.password(excel.readData(1,1));
		Thread.sleep(2000);
		screenshotCode.captureScreenshot(driver, "Login_Screen");
		rp.submit();
		Thread.sleep(4000);
		...
		driver.findElement(By.xpath("//div[@aria-label='Summary']")).sendKeys("Welcome to the Selenium Automation Demo"); //summary field
		...
		Thread.sleep(2000);
		screenshotCode.captureScreenshot(driver, "CR_Analysis state");
		//Link & Attachments
...
//CREATING TASK WI		
	...
	Thread.sleep(2000);
	screenshotCode.captureScreenshot(driver, "Link to task");
	Thread.sleep(3000);
	driver.findElement(By.xpath("//span[text()='Create Linked Task...']")).click(); //create linked task
	Thread.sleep(4000);
	driver.findElement(By.xpath("(//div[@aria-label='Summary'])[2]")).sendKeys("Welcome to the Selenium Automation Demo"); //summary
	Thread.sleep(2000);
...
driver.findElement(By.xpath("(//div[@class='RichTextEditorWidget ViewBorder com-ibm-team-workitem-shared-RichText cke_editable cke_editable_inline cke_contents_ltr'])[3]")).sendKeys("Test Automation");//implementation coment
	...
	screenshotCode.captureScreenshot(driver, "Task_Created");
	...
	System.out.println("CR is created with one Task closed");
				...
				Thread.sleep(2000);
		driver.findElement(By.xpath("(//a[text()='Summary'])[2]")).click();
		Thread.sleep(3000);
		screenshotCode.captureScreenshot(driver, "CR Created");
